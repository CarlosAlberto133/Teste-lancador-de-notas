...
function Bimestre4() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get<Nota[]>('http://localhost:3333/resultados/QUARTO')
    ...
    return (
        <div className='container'>
            <div className='infoContainer'>
                <label className='bimestres'>Bimestre 4</label>
